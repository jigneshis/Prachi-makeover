        ...
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <Button className="luxury-button py-2 px-6 text-sm">Book Now</Button>
            </div>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-cream border-b border-gold/10 animate-in slide-in-from-top duration-300">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link href="#services" className="block px-3 py-2 text-base font-medium text-gray-700">Services</Link>
            <Link href="#gallery" className="block px-3 py-2 text-base font-medium text-gray-700">Gallery</Link>
            <Link href="#about" className="block px-3 py-2 text-base font-medium text-gray-700">About</Link>
